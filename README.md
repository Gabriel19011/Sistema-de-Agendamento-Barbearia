...
*   **Gabriel Smarzaro Santos** (Desenvolvedor Front-end & UI/UX)
    *   *Contribuições:* Estruturação semântica das telas em HTML5, estilização responsiva com CSS3 (Mobile-First), lógica de interação dinâmica do DOM e integração assíncrona com a API.
